...
class TestClientIpRelatedDnsRecord(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ClientIpRelatedDnsRecord:
        """Test ClientIpRelatedDnsRecord
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ClientIpRelatedDnsRecord`
        """
        model = ClientIpRelatedDnsRecord()
        if include_optional:
            return ClientIpRelatedDnsRecord(
                id = 1,
                name = 'watchtowr.com',
                type = 'A',
                ttl = 60,
    ...
    def testClientIpRelatedDnsRecord(self):
        """Test ClientIpRelatedDnsRecord"""
