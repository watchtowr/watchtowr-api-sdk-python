...
class TestWhoisDataObjectNameServers(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> WhoisDataObjectNameServers:
        """Test WhoisDataObjectNameServers
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WhoisDataObjectNameServers`
        """
        model = WhoisDataObjectNameServers()
        if include_optional:
            return WhoisDataObjectNameServers(
            )
        else:
            return WhoisDataObjectNameServers(
        )
    ...
    def testWhoisDataObjectNameServers(self):
        """Test WhoisDataObjectNameServers"""
