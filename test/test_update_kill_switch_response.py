...
class TestUpdateKillSwitchResponse(unittest.TestCase):
    """UpdateKillSwitchResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateKillSwitchResponse:
        """Test UpdateKillSwitchResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateKillSwitchResponse`
        """
        model = UpdateKillSwitchResponse()
        if include_optional:
    ...
    def testUpdateKillSwitchResponse(self):
        """Test UpdateKillSwitchResponse"""
