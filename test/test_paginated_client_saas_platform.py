...
class TestPaginatedClientSaasPlatform(unittest.TestCase):
    """PaginatedClientSaasPlatform unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaginatedClientSaasPlatform:
        """Test PaginatedClientSaasPlatform
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaginatedClientSaasPlatform`
        """
        model = PaginatedClientSaasPlatform()
        if include_optional:
            return PaginatedClientSaasPlatform(
                data = [
                    watchtowr_api_sdk.models.client_saas_platform.ClientSaasPlatform(
                        type = 'saasPlatform', 
    ...
    def testPaginatedClientSaasPlatform(self):
        """Test PaginatedClientSaasPlatform"""
