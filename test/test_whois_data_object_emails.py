...
class TestWhoisDataObjectEmails(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> WhoisDataObjectEmails:
        """Test WhoisDataObjectEmails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WhoisDataObjectEmails`
        """
        model = WhoisDataObjectEmails()
        if include_optional:
            return WhoisDataObjectEmails(
            )
        else:
            return WhoisDataObjectEmails(
        )
    ...
    def testWhoisDataObjectEmails(self):
        """Test WhoisDataObjectEmails"""
