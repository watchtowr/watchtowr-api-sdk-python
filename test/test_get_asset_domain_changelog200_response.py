...
class TestGetAssetDomainChangelog200Response(unittest.TestCase):
    """GetAssetDomainChangelog200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAssetDomainChangelog200Response:
        """Test GetAssetDomainChangelog200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAssetDomainChangelog200Response`
        """
        model = GetAssetDomainChangelog200Response()
        if include_optional:
            return GetAssetDomainChangelog200Response(
                data = [{"id":1,"description":"Domain created.","type":"Add Asset","properties":{"attributes":{"name":"example.com"}},"created_at":"2025-11-25T05:24:59.000Z","caused_by":{"id":1,"name":"watchTowr Platform"}},{"id":2,"description":"Domain updated (status).","type":"Asset Status Change","properties":{"old":{"status_name":"pending","status_reason":"Requires verification"},"attributes":{"status_name":"verified","status_reason":"Manually verified via Client API"}},"created_at":"2025-11-25T05:25:00.000Z","caused_by":{"id":54,"name":"John Doe"}}],
    ...
    def testGetAssetDomainChangelog200Response(self):
        """Test GetAssetDomainChangelog200Response"""
