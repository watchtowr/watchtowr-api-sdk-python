...
class TestKevTypes(unittest.TestCase):
    """KevTypes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> KevTypes:
        """Test KevTypes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `KevTypes`
        """
        model = KevTypes()
        if include_optional:
            return KevTypes(
