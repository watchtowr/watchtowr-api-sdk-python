...
class TestVulnEpss(unittest.TestCase):
    """VulnEpss unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VulnEpss:
        """Test VulnEpss
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VulnEpss`
        """
        model = VulnEpss()
        if include_optional:
            return VulnEpss(
