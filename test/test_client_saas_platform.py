...
class TestClientSaasPlatform(unittest.TestCase):
    """ClientSaasPlatform unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ClientSaasPlatform:
        """Test ClientSaasPlatform
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ClientSaasPlatform`
        """
        model = ClientSaasPlatform()
        if include_optional:
            return ClientSaasPlatform(
                type = 'saasPlatform',
    ...
    def testClientSaasPlatform(self):
        """Test ClientSaasPlatform"""
