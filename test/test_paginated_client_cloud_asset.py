...
class TestPaginatedClientCloudAsset(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PaginatedClientCloudAsset:
        """Test PaginatedClientCloudAsset
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaginatedClientCloudAsset`
        """
        model = PaginatedClientCloudAsset()
        if include_optional:
    ...
    def testPaginatedClientCloudAsset(self):
        """Test PaginatedClientCloudAsset"""
