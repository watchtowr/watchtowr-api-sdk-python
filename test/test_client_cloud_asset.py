...
class TestClientCloudAsset(unittest.TestCase):
    """ClientCloudAsset unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ClientCloudAsset:
        """Test ClientCloudAsset
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ClientCloudAsset`
        """
        model = ClientCloudAsset()
        if include_optional:
            return ClientCloudAsset(
                type = 'cloudAsset',
