...
class TestClientIpRelatedDnsRecordAsset(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ClientIpRelatedDnsRecordAsset:
        """Test ClientIpRelatedDnsRecordAsset
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ClientIpRelatedDnsRecordAsset`
        """
        model = ClientIpRelatedDnsRecordAsset()
        if include_optional:
            return ClientIpRelatedDnsRecordAsset(
                id = 1,
                name = 'watchtowr.com'
            )
        else:
    ...
    def testClientIpRelatedDnsRecordAsset(self):
        """Test ClientIpRelatedDnsRecordAsset"""
