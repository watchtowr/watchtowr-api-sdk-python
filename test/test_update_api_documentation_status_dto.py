...
class TestUpdateApiDocumentationStatusDto(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UpdateApiDocumentationStatusDto:
        """Test UpdateApiDocumentationStatusDto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateApiDocumentationStatusDto`
        """
        model = UpdateApiDocumentationStatusDto()
        if include_optional:
            return UpdateApiDocumentationStatusDto(
                status = 'verified',
    ...
    def testUpdateApiDocumentationStatusDto(self):
        """Test UpdateApiDocumentationStatusDto"""
