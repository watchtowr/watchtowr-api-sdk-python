...
class TestTechnologyStatistic(unittest.TestCase):
    """TechnologyStatistic unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TechnologyStatistic:
        """Test TechnologyStatistic
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TechnologyStatistic`
        """
        model = TechnologyStatistic()
        if include_optional:
    ...
    def testTechnologyStatistic(self):
        """Test TechnologyStatistic"""
