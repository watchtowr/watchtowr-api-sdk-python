...
class TestRemoveClientCustomPropertyResponseDto(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> RemoveClientCustomPropertyResponseDto:
        """Test RemoveClientCustomPropertyResponseDto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RemoveClientCustomPropertyResponseDto`
        """
        model = RemoveClientCustomPropertyResponseDto()
        if include_optional:
            return RemoveClientCustomPropertyResponseDto(
    ...
    def testRemoveClientCustomPropertyResponseDto(self):
        """Test RemoveClientCustomPropertyResponseDto"""
