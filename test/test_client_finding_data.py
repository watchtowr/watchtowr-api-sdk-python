...
class TestClientFindingData(unittest.TestCase):
    """ClientFindingData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ClientFindingData:
        """Test ClientFindingData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ClientFindingData`
        """
        model = ClientFindingData()
        if include_optional:
            return ClientFindingData(
                data = watchtowr_api_sdk.models.client_finding.ClientFinding(
                    id = 1, 
...
', 
    ...
    def testClientFindingData(self):
        """Test ClientFindingData"""
