...
class TestPaginatedClientFindingRetestHistory(unittest.TestCase):
    """PaginatedClientFindingRetestHistory unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaginatedClientFindingRetestHistory:
        """Test PaginatedClientFindingRetestHistory
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaginatedClientFindingRetestHistory`
        """
        model = PaginatedClientFindingRetestHistory()
        if include_optional:
            return PaginatedClientFindingRetestHistory(
                data = [
                    watchtowr_api_sdk.models.client_finding_retest_history.ClientFindingRetestHistory(
                        id = 789, 
                        finding = null, 
                        asset = null, 
                        triggered_by = null, 
    ...
    def testPaginatedClientFindingRetestHistory(self):
        """Test PaginatedClientFindingRetestHistory"""
