...
class TestServiceInformationResponse(unittest.TestCase):
    """ServiceInformationResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ServiceInformationResponse:
        """Test ServiceInformationResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ServiceInformationResponse`
        """
        model = ServiceInformationResponse()
        if include_optional:
    ...
    def testServiceInformationResponse(self):
        """Test ServiceInformationResponse"""
