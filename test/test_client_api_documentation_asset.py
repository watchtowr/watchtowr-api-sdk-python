...
class TestClientApiDocumentationAsset(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ClientApiDocumentationAsset:
        """Test ClientApiDocumentationAsset
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ClientApiDocumentationAsset`
        """
        model = ClientApiDocumentationAsset()
        if include_optional:
            return ClientApiDocumentationAsset(
                id = 1,
    ...
    def testClientApiDocumentationAsset(self):
        """Test ClientApiDocumentationAsset"""
