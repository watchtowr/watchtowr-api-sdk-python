...
class TestClientSuspiciousDomainData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ClientSuspiciousDomainData:
        """Test ClientSuspiciousDomainData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ClientSuspiciousDomainData`
        """
...
Registrar Registration Expiration Date: 2027-06-17T04:00:00Z
    ...
    def testClientSuspiciousDomainData(self):
        """Test ClientSuspiciousDomainData"""
