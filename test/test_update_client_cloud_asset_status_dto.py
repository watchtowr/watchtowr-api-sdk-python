...
class TestUpdateClientCloudAssetStatusDto(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UpdateClientCloudAssetStatusDto:
        """Test UpdateClientCloudAssetStatusDto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateClientCloudAssetStatusDto`
        """
        model = UpdateClientCloudAssetStatusDto()
        if include_optional:
            return UpdateClientCloudAssetStatusDto(
                status = 'verified',
    ...
    def testUpdateClientCloudAssetStatusDto(self):
        """Test UpdateClientCloudAssetStatusDto"""
