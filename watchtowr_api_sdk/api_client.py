...
from watchtowr_api_sdk.api_response import ApiResponse, T as ApiResponseT
import watchtowr_api_sdk.models
from watchtowr_api_sdk import rest
from watchtowr_api_sdk.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(watchtowr_api_sdk.models, klass)
