...
class ActiveDefenseLibraryApi:
    ...
    @validate_call
    def get_active_defense_library_rule_details(
        self,
        rule_id: Annotated[StrictFloat, Field(description="The numeric rule ID of the Active Defense Library rule to retrieve.")],
        ...
        :param rule_id: The numeric rule ID of the Active Defense Library rule to retrieve. (required)
        :type rule_id: float
        ...
        _param = self._get_active_defense_library_rule_details_serialize(
            rule_id=rule_id,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ClientActiveDefenseRuleData",
            '401': "Unauthorized",
    ...
    @validate_call
    def get_active_defense_library_rule_details_with_http_info(
        self,
        rule_id: Annotated[StrictFloat, Field(description="The numeric rule ID of the Active Defense Library rule to retrieve.")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ClientActiveDefenseRuleData]:
        """Get Active Defense Rule Details
    ...
    @validate_call
    def get_active_defense_library_rule_details_without_preload_content(
        self,
        rule_id: Annotated[StrictFloat, Field(description="The numeric rule ID of the Active Defense Library rule to retrieve.")],
        _request_timeout: Union[
            None,
    ...
    def _get_active_defense_library_rule_details_serialize(
        self,
        rule_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/client/active-defense-library/show/{ruleId}',
    ...
    @validate_call
    def get_active_defense_library_rule_provider_template(
        self,
        rule_id: Annotated[StrictFloat, Field(description="The numeric rule ID of the Active Defense Library rule.")],
        provider: Annotated[StrictStr, Field(description="The WAF provider whose rule template should be returned.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param rule_id: The numeric rule ID of the Active Defense Library rule. (required)
        :type rule_id: float
        :param provider: The WAF provider whose rule template should be returned. (required)
        :type provider: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._get_active_defense_library_rule_provider_template_serialize(
            rule_id=rule_id,
            provider=provider,
            _request_auth=_request_auth,
            _content_type=_content_type,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ClientActiveDefenseRuleProviderData",
            '401': "Unauthorized",
            '403': "ForbiddenResponse",
            '404': "NotFound",
        }
    ...
    @validate_call
    def get_active_defense_library_rule_provider_template_with_http_info(
        self,
        rule_id: Annotated[StrictFloat, Field(description="The numeric rule ID of the Active Defense Library rule.")],
        provider: Annotated[StrictStr, Field(description="The WAF provider whose rule template should be returned.")],
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ClientActiveDefenseRuleProviderData]:
        """Get Active Defense Rule Provider Template
    ...
    @validate_call
    def get_active_defense_library_rule_provider_template_without_preload_content(
        self,
        rule_id: Annotated[StrictFloat, Field(description="The numeric rule ID of the Active Defense Library rule.")],
        provider: Annotated[StrictStr, Field(description="The WAF provider whose rule template should be returned.")],
        _request_timeout: Union[
    ...
    def _get_active_defense_library_rule_provider_template_serialize(
        self,
        rule_id,
        provider,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/client/active-defense-library/show/{ruleId}/provider/show/{provider}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_list_active_defense_library_rules(
        self,
        ...
        search: Annotated[Optional[StrictStr], Field(description="Search rules by rule name, CVE ID, or watchTowr vulnerability ID.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param search: Search rules by rule name, CVE ID, or watchTowr vulnerability ID.
        :type search: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._get_list_active_defense_library_rules_serialize(
            page=page,
            page_size=page_size,
            search=search,
            _request_auth=_request_auth,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "PaginatedActiveDefenseRules",
            '401': "Unauthorized",
        }
        response_data = self.api_client.call_api(
            *_param,
    ...
    @validate_call
    def get_list_active_defense_library_rules_with_http_info(
        self,
        page: Annotated[Optional[StrictFloat], Field(description="The page number for paginated results. If the page field is not provided in the request, it defaults to 1, which corresponds to the first page of results.")] = None,
        page_size: Annotated[Optional[StrictFloat], Field(description="The number of items to be included on each page of paginated results. If the pageSize field is not specified, it defaults to 10. The maximum for pageSize is 30.")] = None,
        search: Annotated[Optional[StrictStr], Field(description="Search rules by rule name, CVE ID, or watchTowr vulnerability ID.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PaginatedActiveDefenseRules]:
        """List Active Defense Rules
    ...
    @validate_call
    def get_list_active_defense_library_rules_without_preload_content(
        self,
        page: Annotated[Optional[StrictFloat], Field(description="The page number for paginated results. If the page field is not provided in the request, it defaults to 1, which corresponds to the first page of results.")] = None,
        page_size: Annotated[Optional[StrictFloat], Field(description="The number of items to be included on each page of paginated results. If the pageSize field is not specified, it defaults to 10. The maximum for pageSize is 30.")] = None,
        search: Annotated[Optional[StrictStr], Field(description="Search rules by rule name, CVE ID, or watchTowr vulnerability ID.")] = None,
    ...
    def _get_list_active_defense_library_rules_serialize(
        self,
        page,
        page_size,
        search,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/client/active-defense-library/list',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
