...
class SecurityPostureDashboardApi:
    ...
    def get_security_posture_dashboard(
        ...
        _param = self._get_security_posture_dashboard_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "SecurityPostureDashboardResponse",
            '401': "Unauthorized",
    ...
    @validate_call
    def get_security_posture_dashboard_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SecurityPostureDashboardResponse]:
        """Get Security Posture Dashboard
    ...
    @validate_call
    def get_security_posture_dashboard_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_security_posture_dashboard_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/client/dashboard/security-posture',
