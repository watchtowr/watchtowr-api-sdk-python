...
class TtpLibraryCategoryItem(BaseModel):
    """
    TtpLibraryCategoryItem
    """ # noqa: E501
    id: StrictFloat = Field(description="Category ID")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in TtpLibraryCategoryItem) in the input: " + _key)
