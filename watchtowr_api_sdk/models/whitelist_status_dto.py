...
class WhitelistStatusDto(BaseModel):
    ...
    WhitelistStatusDto
    """ # noqa: E501
    enabled: StrictBool = Field(description="Enable or disable whitelisting")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in WhitelistStatusDto) in the input: " + _key)
