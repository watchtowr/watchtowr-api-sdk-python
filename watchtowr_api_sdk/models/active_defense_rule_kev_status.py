...
class ActiveDefenseRuleKevStatus(BaseModel):
    """
    ActiveDefenseRuleKevStatus
    """ # noqa: E501
    cisa: StrictBool
    vulncheck: StrictBool
    watchtowr: StrictBool
    __properties: ClassVar[List[str]] = ["cisa", "vulncheck", "watchtowr"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in ActiveDefenseRuleKevStatus) in the input: " + _key)

        _obj = cls.model_validate({
            "cisa": obj.get("cisa"),
            "vulncheck": obj.get("vulncheck"),
            "watchtowr": obj.get("watchtowr")
        })
        return _obj
