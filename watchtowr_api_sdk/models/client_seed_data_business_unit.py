...
class ClientSeedDataBusinessUnit(BaseModel):
    ...
    """ # noqa: E501
    id: StrictFloat = Field(description="Business Unit ID")
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "description", "type", "createdAt", "updatedAt"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in ClientSeedDataBusinessUnit) in the input: " + _key)
