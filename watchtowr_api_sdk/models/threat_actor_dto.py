...
class ThreatActorDto(BaseModel):
    ...
    ThreatActorDto
    """ # noqa: E501
    attacker_name: StrictStr = Field(description="Threat actor name", alias="attackerName")
    country: StrictStr = Field(description="Country code")
    __properties: ClassVar[List[str]] = ["attackerName", "country"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in ThreatActorDto) in the input: " + _key)

        _obj = cls.model_validate({
            "attackerName": obj.get("attackerName"),
