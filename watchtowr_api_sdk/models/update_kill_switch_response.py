...
class UpdateKillSwitchResponse(BaseModel):
    ...
    """ # noqa: E501
    enabled: StrictBool = Field(description="Updated kill switch status")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in UpdateKillSwitchResponse) in the input: " + _key)
