...
class ServiceInformationAsset(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "type", "businessUnits"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in ServiceInformationAsset) in the input: " + _key)
