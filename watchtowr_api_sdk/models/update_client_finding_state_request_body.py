...
class UpdateClientFindingStateRequestBody(BaseModel):
    ...
    """ # noqa: E501
    state: StrictStr = Field(description="Finding state. Different to status, this is about tracking how the finding is being handled.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in UpdateClientFindingStateRequestBody) in the input: " + _key)
