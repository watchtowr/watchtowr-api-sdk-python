...
class TechnologyStatistic(BaseModel):
    ...
    TechnologyStatistic
    """ # noqa: E501
    name: StrictStr = Field(description="Technology name")
    count: StrictFloat = Field(description="Number of services using this technology")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in TechnologyStatistic) in the input: " + _key)
