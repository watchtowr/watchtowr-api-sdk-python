...
class ClientFindingRetestHistoryFinding(BaseModel):
    """
    ClientFindingRetestHistoryFinding
    """ # noqa: E501
    id: StrictFloat = Field(description="Finding ID")
    title: StrictStr = Field(description="Finding title")
    severity: StrictStr = Field(description="Finding severity")
    status: StrictStr = Field(description="Finding status")
    __properties: ClassVar[List[str]] = ["id", "title", "severity", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in ClientFindingRetestHistoryFinding) in the input: " + _key)
