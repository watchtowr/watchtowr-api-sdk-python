...
class UnprocessableContent(BaseModel):
    """
    UnprocessableContent
    """ # noqa: E501
    message: StrictStr
    status_code: StrictFloat
    errors: Dict[str, Any]
    __properties: ClassVar[List[str]] = ["message", "status_code", "errors"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in UnprocessableContent) in the input: " + _key)
