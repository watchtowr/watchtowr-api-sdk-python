...
class ActiveDefenseRuleTemplate(BaseModel):
    """
    ActiveDefenseRuleTemplate
    """ # noqa: E501
    type: StrictStr
    content: Dict[str, Any] = Field(description="Provider-specific rule content (shape varies by provider).")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in ActiveDefenseRuleTemplate) in the input: " + _key)
