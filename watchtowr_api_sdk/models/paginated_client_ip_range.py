    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in PaginatedClientIpRange) in the input: " + _key)

        _obj = cls.model_validate({
            "data": [ClientIpRange.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
