...
class VulnEpss(BaseModel):
    """
    VulnEpss
    """ # noqa: E501
    score: Optional[StrictFloat] = None
    percentile: Optional[StrictFloat] = None
    epss_score_level: Optional[StrictStr] = Field(default=None, alias="epssScoreLevel")
    __properties: ClassVar[List[str]] = ["score", "percentile", "epssScoreLevel"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in VulnEpss) in the input: " + _key)

        _obj = cls.model_validate({
            "score": obj.get("score"),
            "percentile": obj.get("percentile"),
            "epssScoreLevel": obj.get("epssScoreLevel")
        })
        return _obj
