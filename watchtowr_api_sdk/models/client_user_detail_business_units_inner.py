...
class ClientUserDetailBusinessUnitsInner(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ClientUserDetailBusinessUnitsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ClientUserDetailBusinessUnitsInner from a dict"""
        if obj is None:
            return None
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in ClientUserDetailBusinessUnitsInner) in the input: " + _key)
