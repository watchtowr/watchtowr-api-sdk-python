...
from pydantic import BaseModel, ConfigDict, StrictFloat, StrictStr, field_validator
from typing import Any, ClassVar, Dict, List, Optional
from typing import Optional, Set
from typing_extensions import Self
from pydantic_core import to_jsonable_python

class VulnCvssV3XMetrics(BaseModel):
    """
    VulnCvssV3XMetrics
    """ # noqa: E501
    vector: Optional[StrictStr] = None
    score: Optional[StrictFloat] = None
    severity: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["vector", "score", "severity"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in VulnCvssV3XMetrics) in the input: " + _key)
