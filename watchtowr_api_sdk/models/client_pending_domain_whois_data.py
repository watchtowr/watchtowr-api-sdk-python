...
class ClientPendingDomainWhoisData(BaseModel):
    ...
    """ # noqa: E501
    raw: StrictStr = Field(description="Raw WHOIS data")
    data: Dict[str, Any] = Field(description="Formatted WHOIS data")
    __properties: ClassVar[List[str]] = ["raw", "data"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in ClientPendingDomainWhoisData) in the input: " + _key)
