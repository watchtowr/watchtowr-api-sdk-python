    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in ClientNoteData) in the input: " + _key)

        _obj = cls.model_validate({
            "data": ClientNote.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
