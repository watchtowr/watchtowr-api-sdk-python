...
class CapecPattern(BaseModel):
    ...
    CapecPattern
    """ # noqa: E501
    capec_id: Optional[StrictStr] = Field(default=None, alias="capecId")
    name: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["capecId", "name"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in CapecPattern) in the input: " + _key)

        _obj = cls.model_validate({
            "capecId": obj.get("capecId"),
            "name": obj.get("name")
        })
        return _obj
