...
class MttrMetricsDto(BaseModel):
    ...
    MttrMetricsDto
    """ # noqa: E501
    mttr: StrictFloat = Field(description="Mean Time To Remediation in hours")
    mttrae: StrictFloat = Field(description="Mean Time To Remediation After Exploitation in hours")
    __properties: ClassVar[List[str]] = ["mttr", "mttrae"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in MttrMetricsDto) in the input: " + _key)

        _obj = cls.model_validate({
            "mttr": obj.get("mttr"),
            "mttrae": obj.get("mttrae")
        })
        return _obj
