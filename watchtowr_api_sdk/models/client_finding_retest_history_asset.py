...
class ClientFindingRetestHistoryAsset(BaseModel):
    ...
    """ # noqa: E501
    id: StrictFloat = Field(description="Asset ID")
    name: StrictStr = Field(description="Asset name")
    type: StrictStr = Field(description="Asset type")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in ClientFindingRetestHistoryAsset) in the input: " + _key)
