...
class InviteClientUsersBodyDto(BaseModel):
    ...
    """ # noqa: E501
    users: List[InviteClientUserDto] = Field(description="List of users to invite")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in InviteClientUsersBodyDto) in the input: " + _key)

        _obj = cls.model_validate({
            "users": [InviteClientUserDto.from_dict(_item) for _item in obj["users"]] if obj.get("users") is not None else None
        })
        return _obj
