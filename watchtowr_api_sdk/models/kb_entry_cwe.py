...
class KbEntryCwe(BaseModel):
    """
    KbEntryCwe
    """ # noqa: E501
    cwe_id: Optional[StrictStr] = Field(default=None, alias="cweId")
    name: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["cweId", "name"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in KbEntryCwe) in the input: " + _key)
