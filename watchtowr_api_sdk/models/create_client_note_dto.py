...
class CreateClientNoteDto(BaseModel):
    ...
    CreateClientNoteDto
    """ # noqa: E501
    note: StrictStr = Field(description="Content of the note.")
    title: Optional[StrictStr] = Field(default=None, description="Title of the note.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in CreateClientNoteDto) in the input: " + _key)
