...
class ClientIp(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["type", "source", "status", "created_at", "updated_at", "deleted_at", "id", "name", "businessUnits", "country", "live", "dns_records", "metadata", "customProperties", "criticality", "infrastructure", "engineSettings"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in ClientIp) in the input: " + _key)
        ...
        _obj = cls.model_validate({
            ...
            "live": obj.get("live"),
            "dns_records": ClientIpDetailDnsRecords.from_dict(obj["dns_records"]) if obj.get("dns_records") is not None else None,
