...
class WhitelistStatusData(BaseModel):
    ...
    WhitelistStatusData
    """ # noqa: E501
    enabled: StrictBool = Field(description="Current whitelisting status")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in WhitelistStatusData) in the input: " + _key)
