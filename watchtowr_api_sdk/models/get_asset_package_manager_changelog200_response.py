...
class GetAssetPackageManagerChangelog200Response(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetAssetPackageManagerChangelog200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetAssetPackageManagerChangelog200Response from a dict"""
        if obj is None:
            return None
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in GetAssetPackageManagerChangelog200Response) in the input: " + _key)
