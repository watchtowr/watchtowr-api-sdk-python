...
class PaginatedClientSeedData(BaseModel):
    ...
    """ # noqa: E501
    data: List[ClientSeedDataListItem] = Field(description="List of submitted seed data items")
    meta: Meta
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in PaginatedClientSeedData) in the input: " + _key)

        _obj = cls.model_validate({
            "data": [ClientSeedDataListItem.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
