...
class HuntDetail(BaseModel):
    ...
    total_findings: StrictFloat = Field(description="Total findings")
    total_assets: StrictFloat = Field(description="Total assets")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in HuntDetail) in the input: " + _key)
