...
class WhitelistIpListData(BaseModel):
    ...
    WhitelistIpListData
    """ # noqa: E501
    data: List[WhitelistIpData] = Field(description="List of whitelisted IPs")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in WhitelistIpListData) in the input: " + _key)

        _obj = cls.model_validate({
            "data": [WhitelistIpData.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
