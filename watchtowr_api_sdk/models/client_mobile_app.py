...
class ClientMobileApp(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["type", "source", "status", "created_at", "updated_at", "id", "name", "publisher", "platform", "app_id", "url", "s3path", "businessUnits", "customProperties", "criticality"]
