...
class PointsOfInterest(BaseModel):
    ...
    asset_id: Union[StrictFloat, StrictInt] = Field(description="Asset ID", alias="assetId")
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "type", "url", "discoveryToolId", "discoveryDate", "assetId", "assetName", "assetType", "businessUnits", "lastSeen"]
