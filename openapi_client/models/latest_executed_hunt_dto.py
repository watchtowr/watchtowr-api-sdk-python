...
class LatestExecutedHuntDto(BaseModel):
    ...
    total_findings: Union[StrictFloat, StrictInt] = Field(description="Number of findings discovered", alias="totalFindings")
    total_assets: Union[StrictFloat, StrictInt] = Field(description="Number of assets affected", alias="totalAssets")
