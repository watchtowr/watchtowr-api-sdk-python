...
class Hunt(BaseModel):
    ...
    total_findings: Union[StrictFloat, StrictInt] = Field(description="Total findings related to this hunt")
    total_assets: Union[StrictFloat, StrictInt] = Field(description="Total assets related to this hunt")
