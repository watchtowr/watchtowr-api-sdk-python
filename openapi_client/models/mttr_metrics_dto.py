...
class MttrMetricsDto(BaseModel):
    ...
    MttrMetricsDto
    """ # noqa: E501
    mttr: Union[StrictFloat, StrictInt] = Field(description="Mean Time To Remediation in hours")
    mttrae: Union[StrictFloat, StrictInt] = Field(description="Mean Time To Remediation After Exploitation in hours")
