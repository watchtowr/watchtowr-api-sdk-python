...
[**get_asset_api_documentation_changelog**](APIDocumentationApi.md#get_asset_api_documentation_changelog) | **GET** /api/client/assets/apiDocumentation/show/{id}/changelog | Get API Documentation Changelog
...
[**set_criticality_api_documentation**](APIDocumentationApi.md#set_criticality_api_documentation) | **PUT** /api/client/assets/apiDocumentation/show/{id}/criticality | Set Criticality
...
> GetAssetApiDocumentationChangelog200Response get_asset_api_documentation_changelog(id, page=page, page_size=page_size)
...
with watchtowr_api_sdk.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = watchtowr_api_sdk.APIDocumentationApi(api_client)
    id = 3.4 # float | The asset ID of the API documentation to retrieve changelog for.
    page = 1 # float | The page number for paginated results. If the page field is not provided in the request, it defaults to 1, which corresponds to the first page of results. (optional)
    page_size = 10 # float | The number of items to be included on each page of paginated results. If the pageSize field is not specified, it defaults to 10. The maximum for pageSize is 30. (optional)

    try:
        # Get API Documentation Changelog
        api_response = api_instance.get_asset_api_documentation_changelog(id, page=page, page_size=page_size)
        print("The response of APIDocumentationApi->get_asset_api_documentation_changelog:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling APIDocumentationApi->get_asset_api_documentation_changelog: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **id** | **float**| The asset ID of the API documentation to retrieve changelog for. | 
 **page** | **float**| The page number for paginated results. If the page field is not provided in the request, it defaults to 1, which corresponds to the first page of results. | [optional] 
 **page_size** | **float**| The number of items to be included on each page of paginated results. If the pageSize field is not specified, it defaults to 10. The maximum for pageSize is 30. | [optional] 

### Return type

[**GetAssetApiDocumentationChangelog200Response**](GetAssetApiDocumentationChangelog200Response.md)
...
> SetCriticalityDataResponseDto set_criticality_api_documentation(id, set_criticality_dto)
...
with watchtowr_api_sdk.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = watchtowr_api_sdk.APIDocumentationApi(api_client)
    id = 3.4 # float | The asset ID of the API Documentation to set criticality for.
    set_criticality_dto = watchtowr_api_sdk.SetCriticalityDto() # SetCriticalityDto | 

    try:
        # Set Criticality
        api_response = api_instance.set_criticality_api_documentation(id, set_criticality_dto)
        print("The response of APIDocumentationApi->set_criticality_api_documentation:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling APIDocumentationApi->set_criticality_api_documentation: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **id** | **float**| The asset ID of the API Documentation to set criticality for. | 
