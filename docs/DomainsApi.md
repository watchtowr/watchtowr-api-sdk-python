...
[**get_asset_domain_changelog**](DomainsApi.md#get_asset_domain_changelog) | **GET** /api/client/assets/domain/show/{id}/changelog | Get Domain Changelog
...
[**set_criticality_domain**](DomainsApi.md#set_criticality_domain) | **PUT** /api/client/assets/domain/show/{id}/criticality | Set Criticality
...
> GetAssetDomainChangelog200Response get_asset_domain_changelog(id, page=page, page_size=page_size)
...
with watchtowr_api_sdk.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = watchtowr_api_sdk.DomainsApi(api_client)
    id = 3.4 # float | The asset ID of the Domain to retrieve changelog for.
    page = 1 # float | The page number for paginated results. If the page field is not provided in the request, it defaults to 1, which corresponds to the first page of results. (optional)
    page_size = 10 # float | The number of items to be included on each page of paginated results. If the pageSize field is not specified, it defaults to 10. The maximum for pageSize is 30. (optional)

    try:
        # Get Domain Changelog
        api_response = api_instance.get_asset_domain_changelog(id, page=page, page_size=page_size)
        print("The response of DomainsApi->get_asset_domain_changelog:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DomainsApi->get_asset_domain_changelog: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **id** | **float**| The asset ID of the Domain to retrieve changelog for. | 
 **page** | **float**| The page number for paginated results. If the page field is not provided in the request, it defaults to 1, which corresponds to the first page of results. | [optional] 
 **page_size** | **float**| The number of items to be included on each page of paginated results. If the pageSize field is not specified, it defaults to 10. The maximum for pageSize is 30. | [optional] 

### Return type

[**GetAssetDomainChangelog200Response**](GetAssetDomainChangelog200Response.md)
...
with watchtowr_api_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # List Domains
        api_response = api_instance.get_list_asset_domains(page=page, page_size=page_size, asset_name=asset_name, statuses=statuses, source=source, integration_connections=integration_connections, business_unit_ids=business_unit_ids, created_from=created_from, created_to=created_to, custom_property_key=custom_property_key, custom_property_value=custom_property_value)
...
> SetCriticalityDataResponseDto set_criticality_domain(id, set_criticality_dto)
...
with watchtowr_api_sdk.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = watchtowr_api_sdk.DomainsApi(api_client)
    id = 3.4 # float | The asset ID of the Domain to set criticality for.
    set_criticality_dto = watchtowr_api_sdk.SetCriticalityDto() # SetCriticalityDto | 

    try:
        # Set Criticality
        api_response = api_instance.set_criticality_domain(id, set_criticality_dto)
        print("The response of DomainsApi->set_criticality_domain:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DomainsApi->set_criticality_domain: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **id** | **float**| The asset ID of the Domain to set criticality for. | 
