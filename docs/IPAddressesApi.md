...
[**get_asset_ip_changelog**](IPAddressesApi.md#get_asset_ip_changelog) | **GET** /api/client/assets/ip/show/{id}/changelog | Get IP Address Changelog
...
[**set_criticality_ip**](IPAddressesApi.md#set_criticality_ip) | **PUT** /api/client/assets/ip/show/{id}/criticality | Set Criticality
...
with watchtowr_api_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Get IP Address Changelog
        api_response = api_instance.get_asset_ip_changelog(id, page=page, page_size=page_size)
        print("The response of IPAddressesApi->get_asset_ip_changelog:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling IPAddressesApi->get_asset_ip_changelog: %s\n" % e)
```
...
# **get_asset_ip_ports**
> PaginatedClientPort get_asset_ip_ports(id, page=page, page_size=page_size, include_closed_port=include_closed_port, include_no_service=include_no_service, created_from=created_from, created_to=created_to)
...
with watchtowr_api_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # List Ports
        api_response = api_instance.get_asset_ip_ports(id, page=page, page_size=page_size, include_closed_port=include_closed_port, include_no_service=include_no_service, created_from=created_from, created_to=created_to)
...
# **get_list_asset_ips**
> PaginatedClientIp get_list_asset_ips(page=page, page_size=page_size, asset_name=asset_name, statuses=statuses, source=source, integration_connections=integration_connections, business_unit_ids=business_unit_ids, created_from=created_from, created_to=created_to, custom_property_key=custom_property_key, custom_property_value=custom_property_value, match_type=match_type)
...
# **set_criticality_ip**
> SetCriticalityDataResponseDto set_criticality_ip(id, set_criticality_dto)
...
with watchtowr_api_sdk.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = watchtowr_api_sdk.IPAddressesApi(api_client)
    id = 3.4 # float | The asset ID of the IP to set criticality for.
    set_criticality_dto = watchtowr_api_sdk.SetCriticalityDto() # SetCriticalityDto | 

    try:
        # Set Criticality
        api_response = api_instance.set_criticality_ip(id, set_criticality_dto)
        print("The response of IPAddressesApi->set_criticality_ip:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling IPAddressesApi->set_criticality_ip: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **id** | **float**| The asset ID of the IP to set criticality for. | 
