...
[**get_asset_subdomain_changelog**](SubdomainsApi.md#get_asset_subdomain_changelog) | **GET** /api/client/assets/subdomain/show/{id}/changelog | Get Subdomain Changelog
...
[**set_criticality_subdomain**](SubdomainsApi.md#set_criticality_subdomain) | **PUT** /api/client/assets/subdomain/show/{id}/criticality | Set Criticality
...
with watchtowr_api_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Subdomain Changelog
        api_response = api_instance.get_asset_subdomain_changelog(id, page=page, page_size=page_size)
        print("The response of SubdomainsApi->get_asset_subdomain_changelog:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SubdomainsApi->get_asset_subdomain_changelog: %s\n" % e)
```
...
> SetCriticalityDataResponseDto set_criticality_subdomain(id, set_criticality_dto)
...
with watchtowr_api_sdk.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = watchtowr_api_sdk.SubdomainsApi(api_client)
    id = 3.4 # float | The asset ID of the Subdomain to set criticality for.
    set_criticality_dto = watchtowr_api_sdk.SetCriticalityDto() # SetCriticalityDto | 

    try:
        # Set Criticality
        api_response = api_instance.set_criticality_subdomain(id, set_criticality_dto)
        print("The response of SubdomainsApi->set_criticality_subdomain:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SubdomainsApi->set_criticality_subdomain: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **id** | **float**| The asset ID of the Subdomain to set criticality for. | 
