...
[**get_asset_saas_platform_changelog**](SaaSPlatformsApi.md#get_asset_saas_platform_changelog) | **GET** /api/client/assets/saasPlatform/show/{id}/changelog | Get SaaS Platform Changelog
...
[**set_criticality_saas_platform**](SaaSPlatformsApi.md#set_criticality_saas_platform) | **PUT** /api/client/assets/saasPlatform/show/{id}/criticality | Set Criticality
...
> GetAssetSaasPlatformChangelog200Response get_asset_saas_platform_changelog(id, page=page, page_size=page_size)
...
with watchtowr_api_sdk.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = watchtowr_api_sdk.SaaSPlatformsApi(api_client)
    id = 3.4 # float | The asset ID of the SaaS Platform to retrieve changelog for.
    page = 1 # float | The page number for paginated results. If the page field is not provided in the request, it defaults to 1, which corresponds to the first page of results. (optional)
    page_size = 10 # float | The number of items to be included on each page of paginated results. If the pageSize field is not specified, it defaults to 10. The maximum for pageSize is 30. (optional)

    try:
        # Get SaaS Platform Changelog
        api_response = api_instance.get_asset_saas_platform_changelog(id, page=page, page_size=page_size)
        print("The response of SaaSPlatformsApi->get_asset_saas_platform_changelog:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SaaSPlatformsApi->get_asset_saas_platform_changelog: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **id** | **float**| The asset ID of the SaaS Platform to retrieve changelog for. | 
 **page** | **float**| The page number for paginated results. If the page field is not provided in the request, it defaults to 1, which corresponds to the first page of results. | [optional] 
 **page_size** | **float**| The number of items to be included on each page of paginated results. If the pageSize field is not specified, it defaults to 10. The maximum for pageSize is 30. | [optional] 

### Return type

[**GetAssetSaasPlatformChangelog200Response**](GetAssetSaasPlatformChangelog200Response.md)
...
> SetCriticalityDataResponseDto set_criticality_saas_platform(id, set_criticality_dto)
...
with watchtowr_api_sdk.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = watchtowr_api_sdk.SaaSPlatformsApi(api_client)
    id = 3.4 # float | The asset ID of the SaaS Platform to set criticality for.
    set_criticality_dto = watchtowr_api_sdk.SetCriticalityDto() # SetCriticalityDto | 

    try:
        # Set Criticality
        api_response = api_instance.set_criticality_saas_platform(id, set_criticality_dto)
        print("The response of SaaSPlatformsApi->set_criticality_saas_platform:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SaaSPlatformsApi->set_criticality_saas_platform: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **id** | **float**| The asset ID of the SaaS Platform to set criticality for. | 
