# watchtowr_api_sdk.PackageManagersApi
...
[**get_asset_package_manager_changelog**](PackageManagersApi.md#get_asset_package_manager_changelog) | **GET** /api/client/assets/packageManager/show/{id}/changelog | Get Package Manager Changelog
...
[**set_criticality_package_manager**](PackageManagersApi.md#set_criticality_package_manager) | **PUT** /api/client/assets/packageManager/show/{id}/criticality | Set Criticality
...
with watchtowr_api_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Package Manager Changelog
        api_response = api_instance.get_asset_package_manager_changelog(id, page=page, page_size=page_size)
        print("The response of PackageManagersApi->get_asset_package_manager_changelog:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PackageManagersApi->get_asset_package_manager_changelog: %s\n" % e)
```
...
with watchtowr_api_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # List Package Managers
        api_response = api_instance.get_list_asset_package_managers(page=page, page_size=page_size, asset_name=asset_name, statuses=statuses, source=source, integration_connections=integration_connections, business_unit_ids=business_unit_ids, created_from=created_from, created_to=created_to, custom_property_key=custom_property_key, custom_property_value=custom_property_value)
...
> SetCriticalityDataResponseDto set_criticality_package_manager(id, set_criticality_dto)
...
with watchtowr_api_sdk.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = watchtowr_api_sdk.PackageManagersApi(api_client)
    id = 3.4 # float | The asset ID of the Package Manager to set criticality for.
    set_criticality_dto = watchtowr_api_sdk.SetCriticalityDto() # SetCriticalityDto | 

    try:
        # Set Criticality
        api_response = api_instance.set_criticality_package_manager(id, set_criticality_dto)
        print("The response of PackageManagersApi->set_criticality_package_manager:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PackageManagersApi->set_criticality_package_manager: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **id** | **float**| The asset ID of the Package Manager to set criticality for. | 
