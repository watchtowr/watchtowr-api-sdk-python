...
[**get_asset_cloud_storage_changelog**](CloudStorageApi.md#get_asset_cloud_storage_changelog) | **GET** /api/client/assets/cloudStorage/show/{id}/changelog | Get Cloud Storage Changelog
...
[**set_criticality_cloud_storage**](CloudStorageApi.md#set_criticality_cloud_storage) | **PUT** /api/client/assets/cloudStorage/show/{id}/criticality | Set Criticality
...
# **get_asset_cloud_storage_changelog**
> GetAssetCloudStorageChangelog200Response get_asset_cloud_storage_changelog(id, page=page, page_size=page_size)
...
with watchtowr_api_sdk.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = watchtowr_api_sdk.CloudStorageApi(api_client)
    id = 3.4 # float | The asset ID of the Cloud Storage to retrieve changelog for.
    page = 1 # float | The page number for paginated results. If the page field is not provided in the request, it defaults to 1, which corresponds to the first page of results. (optional)
    page_size = 10 # float | The number of items to be included on each page of paginated results. If the pageSize field is not specified, it defaults to 10. The maximum for pageSize is 30. (optional)

    try:
        # Get Cloud Storage Changelog
        api_response = api_instance.get_asset_cloud_storage_changelog(id, page=page, page_size=page_size)
        print("The response of CloudStorageApi->get_asset_cloud_storage_changelog:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CloudStorageApi->get_asset_cloud_storage_changelog: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **id** | **float**| The asset ID of the Cloud Storage to retrieve changelog for. | 
 **page** | **float**| The page number for paginated results. If the page field is not provided in the request, it defaults to 1, which corresponds to the first page of results. | [optional] 
 **page_size** | **float**| The number of items to be included on each page of paginated results. If the pageSize field is not specified, it defaults to 10. The maximum for pageSize is 30. | [optional] 

### Return type

[**GetAssetCloudStorageChangelog200Response**](GetAssetCloudStorageChangelog200Response.md)
...
# **set_criticality_cloud_storage**
> SetCriticalityDataResponseDto set_criticality_cloud_storage(id, set_criticality_dto)
...
with watchtowr_api_sdk.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = watchtowr_api_sdk.CloudStorageApi(api_client)
    id = 3.4 # float | The asset ID of the Cloud Storage to set criticality for.
    set_criticality_dto = watchtowr_api_sdk.SetCriticalityDto() # SetCriticalityDto | 

    try:
        # Set Criticality
        api_response = api_instance.set_criticality_cloud_storage(id, set_criticality_dto)
        print("The response of CloudStorageApi->set_criticality_cloud_storage:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CloudStorageApi->set_criticality_cloud_storage: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **id** | **float**| The asset ID of the Cloud Storage to set criticality for. | 
